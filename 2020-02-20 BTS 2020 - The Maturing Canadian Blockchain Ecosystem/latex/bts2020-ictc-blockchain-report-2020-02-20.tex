...
%  \cite{ictc2019:blockchain}
  ...
  \column{0.5\textwidth}
    ...
    \vspace{1em}
    Source: Web (incl. partner LinkedIn), plus 24 interviews, and two group discussions.
  \end{columns}
}
...
%  \cite{ictc2019:blockchain}
  ...
  \caption{\tiny Photo by Pawel Nolbert on Unsplash}
	\end{figure}
  \column{0.5\textwidth}
    \vspace{2em}
    \begin{itemize}
...
\frame{
  ...
  \vspace{2em}
  \normalsize 
  We need a comprehensive approach to grow the digital economy
  \begin{itemize}
