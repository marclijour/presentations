...
\newcommand{\ICTCcoverpage}{\frame[plain]{
	...
	\tikz[remember picture,overlay] {
			...
			{\TINY\color{white}\emph{The Information and Communications Technology Council (ICTC) is a not-for-profit national centre of expertise}};
        	\node(footnote) at ([xshift=0cm,yshift=-4.2cm]current page.center) 
			{\TINY\color{white}\emph{formed to strengthen Canada's digital advantage in a global economy.}};
    	}
}}
%
