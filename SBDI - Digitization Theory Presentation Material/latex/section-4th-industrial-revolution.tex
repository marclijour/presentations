...
\frame{
	...
	\begin{itemize}
		...
		\item Symbian was the leading operating system 10+ years ago, now Android rules
	\end{itemize}
}
...
\frame{
	...
	\framesubtitle{The pace of change}
	\begin{figure}
	\includegraphics[width=10cm]{../pics/symbian-marketshare}
	\caption{Credit: \href{http://www.phonearena.com/news/5-things-that-Nokia-did-before-but-not-necessarily-better-than-Google_id63345}{phoneArena.com}}
	\end{figure}
}
...
\frame{
	...
	\framesubtitle{The pace of change}
	\begin{figure}
	\includegraphics[width=6.5cm]{../pics/windows-notruling}
	\caption{Credit: \href{https://www.youtube.com/watch?v=pYGqzUAAvCs}{World Economic Forum (2017)}}
	\end{figure}
}
