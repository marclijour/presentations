...
\frame{
	\frametitle{Small Business Digitization Initiative}
	\framesubtitle{Certifications Path to Consider after this Course}
	\begin{figure}
		\centering
		\includegraphics[height=6cm]{../pics/pmi-pba-certification}
		\caption{From the Project Management Institute (PMI)}
	\end{figure}
}
...
\frame{
	...
	\begin{figure}
		\centering
		\includegraphics[height=6cm]{../pics/iiba-ecba}
		\caption{From the International Institute of Business Analysis (IIBA)}
	\end{figure}
}
