...
\newcommand{\Metameshcoverpage}{\frame[plain]{
	\tikz[remember picture,overlay] {
        	...
        	\node(logo) at ([xshift=0cm,yshift=2.7cm]current page.center) 
		 	{\includegraphics[scale=.2]{../../Metamesh-LaTeX_Templates/images/logo-full}};
	...
	\tikz[remember picture,overlay] {
			...
			{\TINY\color{white}\emph{Metamesh Group is launching in 2019 supported by 30 Industry experts across 5 continents}};
...
\logo{
	\includegraphics[scale=.5]{../../Metamesh-LaTeX_Templates/images/logo}
}
\AtBeginSection[]
{
  \begin{frame}
