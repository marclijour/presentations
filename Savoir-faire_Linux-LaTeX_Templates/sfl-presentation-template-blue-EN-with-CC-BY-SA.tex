...
\newcommand{\SFLcoverpage}{\frame[plain]{
	\tikz[remember picture,overlay] {
			...
			{\includegraphics[width=\paperwidth, height=\paperheight]{../../Savoir-faire_Linux-LaTeX_Templates/images/sfl-background-blue}};
			...
			{\href{https://creativecommons.org/licenses/by-sa/2.5/ca/}{\includegraphics[scale=.4]{../../Savoir-faire_Linux-LaTeX_Templates/images/CC-BY-SA-403x141}}};
	}
	\tikz[remember picture,overlay] {
