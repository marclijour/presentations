...
% --------------------------------------------------------------------
\usetheme{Boadilla}
% Set color close to CE palette
%\definecolor{beamer@blendedblue}{RGB}{150,36,36}
\definecolor{beamer@blendedblue}{RGB}{124,42,39}		% close to CE colour palette
%\definecolor{beamer@blendedblue}{RGB}{93,96,93}		% cool gray
...
\newcommand{\CEcoverpage}{\frame[plain]{
	\tikz[remember picture,overlay] {
			...
			{\includegraphics[width=\paperwidth, height=\paperheight]{../../Creative_Emergy-LaTeX_Templates/images/bkg4}};
			
			% logo positionned top left
      %  	\node(logo) at ([xshift=-4.2cm,yshift=3.5cm]current page.center) 
		 	...
		 	% logo positionned bottom left
        	\node(logo) at ([xshift=-4.2cm,yshift=-4cm]current page.center) 
		 	{\includegraphics[scale=.07]{../../Creative_Emergy-LaTeX_Templates/images/ce_logo_hr_name}};
	...
	\tikz[remember picture,overlay] {
      %  	\node(title) at ([xshift=0cm,yshift=0cm]current page.center)
        	\node(title) at ([xshift=0cm,yshift=0.7cm]current page.center) 
...
% This sets the Creative Emergy logo at the top right corner of each page (modifying the chosen theme)
\setbeamertemplate{headline}{\hfill\includegraphics[width=.8cm]{../../Creative_Emergy-LaTeX_Templates/images/Quetzalcoatl_Ourobouros-coloured-same}\hspace{0.2cm}\vspace{-1.1cm}}
%
% This sets the Creative Emergy logo at the bottom right corner of each page (as determined by the chosen theme)
%\logo{	\includegraphics[scale=.05]{../../Creative_Emergy-LaTeX_Templates/images/Quetzalcoatl_Ourobouros-coloured-same}}
