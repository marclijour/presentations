...
% ---------------------- USER-DEFINED --------------------------------
\newcommand{\Metameshtitle}{Blockchain in business}
\newcommand{\Metameshlongtitle}{An Introduction to Blockchain for Entrepreneurs}
\newcommand{\Metameshsubtitle}{Hands-on}
\newcommand{\Metameshauthor}{Marc~Lijour}
\newcommand{\Metameshdate}{January~28, 2019}
\newcommand{\Metameshsubject}{Lozard Institute}
% --------------------------------------------------------------------
% Template
\input{../../Metamesh-LaTeX_Templates/Metamesh-presentation-template-EN-with-CC-BY-SA.tex}
% Extra packages
\usepackage{amssymb}
\usepackage{amsmath}
