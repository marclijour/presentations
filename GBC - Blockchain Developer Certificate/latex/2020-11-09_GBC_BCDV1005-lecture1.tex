...
\newcommand{\CElongtitle}{Introduction to blockchain applications in industry}
\newcommand{\CEsubtitle}{with a focus on financial services}
\newcommand{\CEauthor}{Marc~Lijour}
\newcommand{\CEdate}{Novembre~9, 2020}
...
\addbibresource{references-ico.bib}
...
% Content
\input{presentation-content-bcdv1005-nature-of-money}
\input{presentation-content-bcdv1005-ICOs}
\frame{
