...
% ---------------------- USER-DEFINED --------------------------------
\newcommand{\CEtitle}{Blockchain}
\newcommand{\CElongtitle}{Introduction to Blockchain}
\newcommand{\CEsubtitle}{a hands-on approach}
\newcommand{\CEauthor}{Marc~Lijour}
\newcommand{\CEdate}{July~16, 2021}
\newcommand{\CEsubject}{Creative~Emergy}
% --------------------------------------------------------------------
% Template
...
% Content
\input{presentation-content-intro01}
\frame{
