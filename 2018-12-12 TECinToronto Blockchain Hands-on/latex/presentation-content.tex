...
\frame{
	...
	\framesubtitle{Do it several times to get more than 1 ether in your account; then donate 1 ether to the faucet}
	\begin{figure}
		\includegraphics[width=5cm]{../pics/ethereum/faucet-ropsten}
	\end{figure}
}
...
\frame{
	...
	\begin{figure}
		\includegraphics[width=5cm]{../pics/ethereum/metamask-tx-pane-2018}
	\end{figure}
}
