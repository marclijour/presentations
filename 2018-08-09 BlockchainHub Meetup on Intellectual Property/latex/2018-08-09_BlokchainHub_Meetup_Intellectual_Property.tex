...
% ---------------------- USER-DEFINED --------------------------------
\newcommand{\ConsenSystitle}{Blockchain \& Intellectual~Property}
\newcommand{\ConsenSyslongtitle}{Blockchain \& Intellectual Property}
\newcommand{\ConsenSyssubtitle}{Empowering people to create (more)}
\newcommand{\ConsenSysauthor}{Marc~Lijour}
\newcommand{\ConsenSysdate}{August~9, 2018}
\newcommand{\ConsenSyssubject}{Intellectual~Property}
% --------------------------------------------------------------------
% Template
\input{../../ConsenSys-LaTeX_Templates/ConsenSys-presentation-template-EN-with-CC-BY-SA.tex}
% Extra packages
\usepackage{amssymb}
\usepackage{amsmath}
\usepackage[american]{babel}
\usepackage{csquotes}
%\usepackage[export]{adjustbox}	% https://tex.stackexchange.com/questions/91566/syntax-similar-to-centering-for-right-and-left
